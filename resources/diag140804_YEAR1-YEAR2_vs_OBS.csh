...
set test_casename  = $EXP
set test_filetype = monthly_history 
#set test_filetype = time_series

set test_path         =  ${SCRATCH}/ACME_simulations/$EXP
set test_path_history =  ${test_path}/run/
set test_path_climo   =  ${test_path}/pp/clim_rgr/${YEAR1}-${YEAR2}/
set test_path_diag    =  ${test_path}/amwg/${YEAR1}-${YEAR2}_vs_OBS/
...
setenv DIAG_HOME /project/projectdirs/acme/golaz/amwg/amwg_diag
