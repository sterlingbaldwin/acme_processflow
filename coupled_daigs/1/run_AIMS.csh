...
set projdir =                           /export/kuivenhoven1/projects/acme_workflow/coupled_daigs/1
...
setenv test_archive_dir                 /export/kuivenhoven1/projects/acme_workflow/tmp/diag/year_set_1
setenv test_short_term_archive          0
setenv test_begin_yr_climo              1
setenv test_end_yr_climo                2
setenv test_begin_yr_ts                 1
setenv test_end_yr_ts                   2
...
setenv ref_case                         None
setenv ref_archive_dir                  
...
setenv yr_offset                        1999    # for 1850 time slices
...
setenv mpas_meshfile                    /space2/mapping/MPAS-grids/ocn/gridfile.oEC60to30.nc
setenv mpas_remapfile                   /space2/mapping/maps/map_oEC60to30_TO_0.5x0.5degree_blin.160412.nc
setenv pop_remapfile                    /space2/mapping/maps/map_gx1v6_TO_0.5x0.5degree_blin.160413.nc
...
setenv remap_files_dir                  /space2/mapping/maps
setenv GPCP_regrid_wgt_file             /space2/mapping/maps/ne30-to-GPCP.conservative.wgts.nc
setenv CERES_EBAF_regrid_wgt_file       /space2/mapping/maps/ne30-to-CERES-EBAF.conservative.wgts.nc
setenv ERS_regrid_wgt_file              /space2/mapping/maps/ne30-to-ERS.conservative.wgts.nc

#Set ocn/ice specific paths to data file names and locations
setenv mpas_climodir                    $test_scratch_dir

setenv obs_ocndir                       /space2/diagnostics/observations/Ocean
setenv obs_seaicedir                    %obs_seaicedir%%
setenv obs_sstdir                       /space2/diagnostics/observations/Ocean/SST
setenv obs_iceareaNH                    /space2/diagnostics/observations/SeaIce/IceArea_timeseries/iceAreaNH_climo.nc
setenv obs_iceareaSH                    /space2/diagnostics/observations/SeaIce/IceArea_timeseries/iceAreaSH_climo.nc
setenv obs_icevolNH                     space2/diagnostics/observations/SeaIce/PIOMAS/PIOMASvolume_monthly_climo.nc
